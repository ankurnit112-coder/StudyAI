  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <div className="container mx-auto px-4 py-8 pb-20 md:pb-8">
        ...
        {/* Board Predictions Demo Notice */}
        <div className="bg-green-50 border border-green-200 rounded-lg p-4 mb-6">
          <div className="flex items-center space-x-2">
            <Brain className="h-5 w-5 text-green-600" />
            <div>
              <h3 className="font-semibold text-green-800">Fully Functional AI Predictions</h3>
              <p className="text-sm text-green-700">
                This Board Predictions feature is fully working! Enter your details below to get real AI-powered CBSE board exam predictions with 94%+ accuracy.
              </p>
            </div>
          </div>
        </div>
